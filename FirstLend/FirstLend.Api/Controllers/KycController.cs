...
namespace FirstLend.Api.Controllers
{
    ...
    public class KycController : ControllerBase
    {
        ...
        /// <summary>
        /// Upload a KYC document (Government ID, Proof of Address, Bank Statement, or Guarantor Document)
        /// </summary>
        /// <remarks>
        /// Document Types:
        ...
        /// - **guarantor_document**: Combined PDF/DOCS containing all of:
        ///   1. Passport photograph
        ///   2. Guarantor's means of identification
        ///   3. Guarantor's CAC or work ID card (to prove ability to pay if user defaults)
        ///   4. Guarantor's form with signature appended
        ///   5. Utility bill for proof of address
        ///   
        /// **Note:** For guarantor_document, please combine all 5 required documents into a single PDF before uploading.
        /// </remarks>
